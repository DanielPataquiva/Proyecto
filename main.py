...
class ServoControl(QWidget):
    ...
    # ------------------------
    def pick(self):
        # Mueve el servo 5 a 0° sin bloquear la GUI
        QTimer.singleShot(0, lambda: self.set_servo_angle(5, 0))

    def place(self):
        # Mueve el servo 5 a 180° sin bloquear la GUI
        QTimer.singleShot(0, lambda: self.set_servo_angle(5, 180))
